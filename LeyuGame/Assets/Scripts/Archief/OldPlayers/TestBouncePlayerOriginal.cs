...
public class TestBouncePlayerOriginal : MonoBehaviour, IPulsingSnow, ISnowTornado, ISnowball
{
	Rigidbody rig;
	Vector3 velocity;
    bool groundedSuspended = false;
    public bool disablePlayerRotation = false;
	...
	public float timingInterval = 1.5f;
